...
# Verbatim snapshot of Agentic-Mixed-Precision-Demo/agents/shared/stability_reducer.py
# at AMP commit 9eccae9 (2026-08-20), taken for the tracked-reduce differential-
# parity harness. The port under tools/tracked_tools/ must reproduce this
# byte-for-byte (parsed-value float compare) on the fixtures in ../fixtures/.
